        ...
        <div className="mt-20 grid gap-6 sm:grid-cols-2 lg:grid-cols-6">
          {clients.map((client, i) => (
            <motion.div
              ...
              className={`group relative rounded-2xl border border-white/[0.06] p-8 backdrop-blur-xl transition-all duration-500 hover:border-gold/20 hover:-translate-y-1 hover:shadow-[0_8px_40px_-12px_rgba(201,169,110,0.15)] ${
            ...
            >
              ...
              {client.link && (
                <a
                  ...
                  className="relative mt-6 inline-flex items-center gap-2 text-sm font-medium text-gold/70 transition-colors duration-300 hover:text-gold"
                >
                  Visit Site
                  <svg
