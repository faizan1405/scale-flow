  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-[400px] h-[400px] rounded-full bg-cyber/[0.04] blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center pt-32 pb-24">
        ...
        >
          <a
            href="#cta"
            className="group relative inline-flex h-14 items-center px-8 rounded-full bg-gold text-dark font-semibold text-base overflow-hidden transition-all duration-300 hover:shadow-[0_0_30px_rgba(201,169,110,0.3)]"
          >
          ...
          <a
            ...
            className="inline-flex h-14 items-center px-8 rounded-full border border-white/10 text-white text-base font-medium hover:border-white/25 hover:bg-white/[0.04] transition-all duration-300"
          >
