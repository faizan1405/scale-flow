              ...
              <ScrollReveal>
                <div className="rounded-2xl p-8 sm:p-10 relative overflow-hidden" style={{ background: "rgba(17,17,17,0.4)", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(255,255,255,0.06)", boxShadow: "0 8px 32px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)" }}>
                  ...
                  <div className="relative z-10">
                    ...
                    <form action="https://formsubmit.co/scaleflowbusiness@gmail.com" method="POST" className="mt-8 space-y-5">
                      <input type="hidden" name="_subject" value="New Website Enquiry from ScaleFlow" /><input type="hidden" name="_captcha" value="false" /><input type="hidden" name="_template" value="table" /><input type="hidden" name="_next" value="https://joinscaleflow.in?sent=true" />
                ...
                <div className="lg:pl-12 rounded-2xl p-8 sm:p-10 relative overflow-hidden" style={{ background: "rgba(17,17,17,0.4)", backdropFilter: "blur(16px) saturate(1.2)", WebkitBackdropFilter: "blur(16px) saturate(1.2)", border: "1px solid rgba(255,255,255,0.06)", boxShadow: "0 8px 32px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.03)" }}>
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-5">
                      <ContactItem icon={<path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 16.92z" />} label="Phone" value="+91 99898 95988" href="tel:+919989895988" />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li><a href="tel:+919989895988" className="text-sm text-gray-text hover:text-gold transition-colors">+91 99898 95988</a></li>
                ...
                <li><a href="https://wa.me/919989895988?text=Hi%20ScaleFlow%2C%20I%E2%80%99m%20interested%20in%20building%20or%20redesigning%20a%20website%20for%20my%20business." target="_blank" rel="noopener noreferrer" className="text-sm text-gray-text hover:text-[#25D366] transition-colors">WhatsApp</a></li>
              </ul>
            </div>
            <div>
